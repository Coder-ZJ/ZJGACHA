...
- (void)initialize {
    ...
    _selectedItemTitleColor = [ZJColor appMainColor];
    ...
    dividingLine.backgroundColor = [ZJColor colorWithHexString:@"0xDCDCDC"];
...
- (void)setHideLine:(BOOL)hideLine{
    ...
    if (hideLine) {
        ...
        _dividingLine.backgroundColor = [ZJColor clearColor];
        self.tracker.backgroundColor = [ZJColor clearColor];
    }
}
