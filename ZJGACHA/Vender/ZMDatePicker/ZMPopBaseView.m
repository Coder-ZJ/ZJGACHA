...
- (UIView *)topView {
    if (!_topView) {
        ...
        _topView.backgroundColor = [ZJColor colorWithHexString:@"#FDFDFD"];
    }
    return _topView;
}
...
//        _leftBtn.layer.borderColor = [ZJColor appMainColor].CGColor;
//        _leftBtn.layer.borderWidth = 1.0f;
        _leftBtn.layer.masksToBounds = YES;
        _leftBtn.titleLabel.font = [UIFont systemFontOfSize:15.0f];
        [_leftBtn setTitleColor:[ZJColor appSupportColor] forState:UIControlStateNormal];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = [ZJColor appSubColor];
