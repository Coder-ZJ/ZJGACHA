...
+ (UIColor *)colorWithHexString:(NSString *)color{
    return [self colorWithHexString:color withAlpha:1.0f];
}
...
+ (UIColor *)appGraySpaceColor{
    return [self colorWithHexString:@"#f4f4f4" withAlpha:1.0f];
}

+ (UIColor *)appSubColor{
    return [self colorWithHexString:@"#333333" withAlpha:1.0f];
}
+ (UIColor *)appSupportColor{
    return [self colorWithHexString:@"#999999" withAlpha:1.0f];
}
+ (UIColor *)appLightGrayColor{
    return [self colorWithHexString:@"#D2D2D2" withAlpha:1.0f];
}
+ (UIColor *)appSubBlueColor{
    return [self colorWithHexString:@"#7EC1FB" withAlpha:1.0f];
}
+ (UIColor *)appBottomLineColor{
    return [self colorWithHexString:@"#DCDCDC" withAlpha:1.0f];
}
